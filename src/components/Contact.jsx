  ...
  return (
    ...
    items-center justify-center">
      ...
      gap-3 space-y-6 p-14">
        ...
        <a href="mailto:fran14.ich@gmail.com" className="text-nowrap rounded-lg border border-indigo-600
        bg-black px-5 py-3 text-lg font-bold text-white shadow-lg shadow-indigo-700
